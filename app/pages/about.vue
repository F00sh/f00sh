<template><PageHero :scene="AboutScene" eyebrow="About" title="Product design, 3D, animation and web connected through visual thinking." intro="FOOSH is the creative work of Marko Vilipic, combining product design experience, 3D visualization, animation, and interactive Nuxt development."><ul class="page-card-grid text-neutral-200"><li v-for="capability in capabilities" :key="capability" data-card class="surface-card">{{ capability }}</li></ul></PageHero></template>
