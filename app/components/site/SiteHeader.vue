<template>
  ...
  >
    <nav class="site-shell flex items-center justify-between py-3 sm:py-4" aria-label="Primary">
      ...
      <ul class="hidden items-center gap-4 md:flex lg:gap-5 xl:gap-6">
    ...
    <div v-if="mobileOpen" class="border-t border-white/10 bg-neutral-950/95 md:hidden">
      <ul class="site-shell flex flex-col py-2">
        <li v-for="item in links" :key="item.to">
