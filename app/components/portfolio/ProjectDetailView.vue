<template>
  <section ref="detailRoot" class="relative pb-20 pt-24 sm:pt-28 lg:pt-32">
    <div class="site-shell max-w-[90rem]">
      ...
      <div class="detail-reveal grid gap-10 border-b border-[var(--foosh-line)] pb-14 lg:grid-cols-12 lg:items-end">
        <div class="lg:col-span-8">
          ...
          <p class="mt-5 max-w-2xl text-base leading-7 text-[var(--foosh-muted)] sm:text-lg">
            {{ project.description }}
          </p>
        </div>
